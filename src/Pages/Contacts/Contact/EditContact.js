...
class EditContact extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            await clienteAxios.get('contact/' + params.id)
                .then(res => {
                    this.setState({
                        form: res.data.contact,
    ...
    submit = async () => {
        tokenAuth(this.props.token);
        try {
            await clienteAxios.put(`contact/${this.state.form.id}`, this.state.form)
                                ...
                                <CardBody>
                                    <Form className="text-right">
                                        ...
                                        <FormGroup className="mb-1" row>
                                            ...
                                            <Col sm={6}>
                                                <CustomInput className="text-left" onChange={this.handleChangeCheck} checked={form.special} type="checkbox"
                                        ...
                                        <FormGroup className="mb-1" row>
                                            <Label for="identication_card" sm={4}>Cédula</Label>
                                            <Col sm={6}>
                                        ...
                                        <FormGroup row>
                                            ...
                                            <Col sm={6}>
                                                <CustomInput className="text-left" onChange={this.handleChangeCheck} checked={form.accounting} type="checkbox"
