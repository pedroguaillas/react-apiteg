...
import {
    Row, Col, Card, CardBody, Table, Form
} from 'reactstrap'
                                        ...
                                        <Col lg={4}>
                                            <Table bordered>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Subtotal 12%</td>
                                                        <td style={{ 'text-align': 'right' }}>${Number(form.base12).toFixed(2)}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Subtotal 0%</td>
                                                        <td style={{ 'text-align': 'right' }}>${Number(form.base0).toFixed(2)}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>IVA</td>
                                                        <td style={{ 'text-align': 'right' }}>${Number(form.iva).toFixed(2)}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>No objeto de IVA</td>
                                                        <td style={{ 'text-align': 'right' }}>${Number(form.no_iva).toFixed(2)}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Descuento</td>
                                                        <td style={{ 'text-align': 'right' }}>${Number(form.discount).toFixed(2)}</td>
                                                    </tr>
                                                    <tr>
                                                        <th style={{ 'text-align': 'center' }}>TOTAL</th>
                                                        <th style={{ 'text-align': 'right' }}>${Number(form.total).toFixed(2)}</th>
                                                    </tr>
                                                </tbody>
                                            </Table>
